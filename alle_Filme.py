...
filmliste = []
file_path = "/tmp/alleFilme.csv"
tmpfile = "/tmp/Filmliste-akt"
file = "/tmp/Filmliste-akt.xz"
...
def downloadList():
    ...
    os.system("[ -e /tmp/Filmliste-akt.xz ] && rm /tmp/Filmliste-akt.xz")
    os.system("[ -e /tmp/alleFilme.sqlite ] && rm /tmp/alleFilme.sqlite")
    os.system(cmd)
    os.system("unxz -q -k -f /tmp/Filmliste-akt.xz")
    os.system("perl -i -pe 's/\"X/$& . ++$n/ge' /tmp/Filmliste-akt")
